...
lazy val i18n = module("i18n", Seq(common, db, user, hub)).settings(
  sourceGenerators in Compile += Def.task {
    MessageCompiler(
      ...
      dbs = "site arena emails learn activity coordinates study patron broadcast streamer tfa settings preferences team perfStat search lag swiss challenge".split(' ').toList,
