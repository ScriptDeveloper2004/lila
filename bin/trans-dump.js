...
const dbs = 'site arena emails learn activity coordinates study patron broadcast streamer tfa settings preferences team perfStat lag swiss challenge'.split(' ');
