...
val `hotmailIsNotoriouslyUnreliable` = new Translated("hotmailIsNotoriouslyUnreliable", Site)
val `yourConfirmationEmailMayNeverArrive` = new Translated("yourConfirmationEmailMayNeverArrive", Site)
