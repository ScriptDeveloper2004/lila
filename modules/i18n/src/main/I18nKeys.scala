...
val `signupEmailHint` = new Translated("signupEmailHint", Site)
...
val `tournDescription` = new Translated("tournDescription", Site)
val `tournDescriptionHelp` = new Translated("tournDescriptionHelp", Site)
val `cancelTournament` = new Translated("cancelTournament", Site)
...
val `variantPractice` = new Translated("variantPractice", Site)
...
val `minimumRatedGames` = new Translated("minimumRatedGames", Site)
val `minimumRating` = new Translated("minimumRating", Site)
val `maximumWeeklyRating` = new Translated("maximumWeeklyRating", Site)
val `onlyTitled` = new Translated("onlyTitled", Site)
val `onlyTitledHelp` = new Translated("onlyTitledHelp", Site)
...
val `faqMenu` = new Translated("faqMenu", Site)
...
val `shareFEN` = new Translated("shareFEN", Site)
...
val `almostThereX` = new Translated("almostThereX", Site)
val `nowCheckYourEmailX` = new Translated("nowCheckYourEmailX", Site)
...
val `notReceivingIt` = new Translated("notReceivingIt", Site)
val `makeSureYourEmailAddressIsCorrect` = new Translated("makeSureYourEmailAddressIsCorrect", Site)
val `waitUpToFiveMinutes` = new Translated("waitUpToFiveMinutes", Site)
val `itCanTakeAWhileToArrive` = new Translated("itCanTakeAWhileToArrive", Site)
val `hotmailIsNotoriouslyBad` = new Translated("hotmailIsNotoriouslyBad", Site)
val `considerUsingADifferentOne` = new Translated("considerUsingADifferentOne", Site)
val `stillNotGettingIt` = new Translated("stillNotGettingIt", Site)
val `didYoumakeSureYourEmailAddressIsCorrect` = new Translated("didYoumakeSureYourEmailAddressIsCorrect", Site)
val `didYouWaitFiveMinutes` = new Translated("didYouWaitFiveMinutes", Site)
val `changeIt` = new Translated("changeIt", Site)
val `thisIsAlreadyYourCurrentEmail` = new Translated("thisIsAlreadyYourCurrentEmail", Site)
val `ifSoX` = new Translated("ifSoX", Site)
val `proceedToThisPage` = new Translated("proceedToThisPage", Site)
val `clickHereForHelp` = new Translated("clickHereForHelp", Site)
val `emailConfirmHelp` = new Translated("emailConfirmHelp", Site)
val `emailConfirmNotReceived` = new Translated("emailConfirmNotReceived", Site)
val `whatSignupUsername` = new Translated("whatSignupUsername", Site)
val `usernameNotFound` = new Translated("usernameNotFound", Site)
val `usernameCanBeUsedForNewAccount` = new Translated("usernameCanBeUsedForNewAccount", Site)
val `emailSent` = new Translated("emailSent", Site)
val `emailCanTakeSomeTime` = new Translated("emailCanTakeSomeTime", Site)
val `refreshInboxAfterFiveMinutes` = new Translated("refreshInboxAfterFiveMinutes", Site)
val `checkSpamFolder` = new Translated("checkSpamFolder", Site)
val `emailForSignupHelp` = new Translated("emailForSignupHelp", Site)
val `copyTextToEmail` = new Translated("copyTextToEmail", Site)
val `waitForSignupHelp` = new Translated("waitForSignupHelp", Site)
val `accountConfirmed` = new Translated("accountConfirmed", Site)
val `accountCanLogin` = new Translated("accountCanLogin", Site)
val `accountConfirmationEmailNotNeeded` = new Translated("accountConfirmationEmailNotNeeded", Site)
val `accountClosed` = new Translated("accountClosed", Site)
val `accountRegisteredWithoutEmail` = new Translated("accountRegisteredWithoutEmail", Site)
...
val `kidModeIsEnabled` = new Translated("kidModeIsEnabled", Site)
...
val `welcomeToLidraughts` = new Translated("welcomeToLidraughts", Site)
val `thisIsYourProfilePage` = new Translated("thisIsYourProfilePage", Site)
val `wouldYouLikeToX` = new Translated("wouldYouLikeToX", Site)
val `improveIt` = new Translated("improveIt", Site)
val `enabledKidModeSuggestion` = new Translated("enabledKidModeSuggestion", Site)
val `whatNowSuggestions` = new Translated("whatNowSuggestions", Site)
val `improveWithDraughtsTacticsPuzzles` = new Translated("improveWithDraughtsTacticsPuzzles", Site)
val `playTheAI` = new Translated("playTheAI", Site)
val `playOpponentsWorldwide` = new Translated("playOpponentsWorldwide", Site)
val `followFriends` = new Translated("followFriends", Site)
val `playInTournaments` = new Translated("playInTournaments", Site)
val `learnFromStudies` = new Translated("learnFromStudies", Site)
val `configureLidraughts` = new Translated("configureLidraughts", Site)
val `exploreTheSiteAndHaveFun` = new Translated("exploreTheSiteAndHaveFun", Site)
...
val `drawStreakStandard` = new Translated("drawStreakStandard", Arena)
val `drawStreakVariants` = new Translated("drawStreakVariants", Arena)
val `variant` = new Translated("variant", Arena)
val `minimumGameLength` = new Translated("minimumGameLength", Arena)
val `history` = new Translated("history", Arena)
val `newTeamBattle` = new Translated("newTeamBattle", Arena)
val `customStartDate` = new Translated("customStartDate", Arena)
val `customStartDateHelp` = new Translated("customStartDateHelp", Arena)
val `allowBerserk` = new Translated("allowBerserk", Arena)
val `allowBerserkHelp` = new Translated("allowBerserkHelp", Arena)
val `allowChatHelp` = new Translated("allowChatHelp", Arena)
val `arenaStreaks` = new Translated("arenaStreaks", Arena)
val `arenaStreaksHelp` = new Translated("arenaStreaksHelp", Arena)
val `noBerserkAllowed` = new Translated("noBerserkAllowed", Arena)
val `noArenaStreaks` = new Translated("noArenaStreaks", Arena)
val `averagePerformance` = new Translated("averagePerformance", Arena)
val `averageScore` = new Translated("averageScore", Arena)
val `myTournaments` = new Translated("myTournaments", Arena)
val `drawingWithinNbMoves` = new Translated("drawingWithinNbMoves", Arena)
val `viewAllXTeams` = new Translated("viewAllXTeams", Arena)
}
...
val `playALegalCapture` = new Translated("playALegalCapture", Learn)
val `winTheGame` = new Translated("winTheGame", Learn)
val `promoteAKing` = new Translated("promoteAKing", Learn)
val `playAllLegalCapturesXRemaining` = new Translated("playAllLegalCapturesXRemaining", Learn)
val `winTheGameInX` = new Translated("winTheGameInX", Learn)
val `promoteAKingInX` = new Translated("promoteAKingInX", Learn)
...
val `unlimited` = new Translated("unlimited", Patron)
...
val `insideTheBoard` = new Translated("insideTheBoard", Preferences)
val `outsideTheBoard` = new Translated("outsideTheBoard", Preferences)
val `coordinateSystem8x8` = new Translated("coordinateSystem8x8", Preferences)
val `fieldnumbers8x8` = new Translated("fieldnumbers8x8", Preferences)
val `algebraic8x8` = new Translated("algebraic8x8", Preferences)
val `moveListWhilePlaying` = new Translated("moveListWhilePlaying", Preferences)
val `onSlowGames` = new Translated("onSlowGames", Preferences)
val `notationGameResult` = new Translated("notationGameResult", Preferences)
...
val `blindfoldDraughts` = new Translated("blindfoldDraughts", Preferences)
val `draughtsClock` = new Translated("draughtsClock", Preferences)
...
val `howDoYouPlayMultiCaptures` = new Translated("howDoYouPlayMultiCaptures", Preferences)
val `stepByStep` = new Translated("stepByStep", Preferences)
val `allAtOnce` = new Translated("allAtOnce", Preferences)
...
val `searchPlayersExplanation` = new Translated("searchPlayersExplanation", Search)
...
val `numberOfTurnsExplanation` = new Translated("numberOfTurnsExplanation", Search)
...
val `sortBy` = new Translated("sortBy", Search)
val `analysis` = new Translated("analysis", Search)
val `onlyAnalysed` = new Translated("onlyAnalysed", Search)
val `color` = new Translated("color", Search)
val `evaluation` = new Translated("evaluation", Search)
val `maxNumber` = new Translated("maxNumber", Search)
val `maxNumberExplanation` = new Translated("maxNumberExplanation", Search)
val `include` = new Translated("include", Search)
val `descending` = new Translated("descending", Search)
val `ascending` = new Translated("ascending", Search)
val `ratingExplanation` = new Translated("ratingExplanation", Search)
