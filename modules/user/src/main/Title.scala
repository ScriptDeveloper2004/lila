...
object Title {
  ...
  val all = Seq(
    ...
    Title("cMF") -> "Candidate FMJD Master",
    ...
    Title("cMFF") -> "Woman Candidate FMJD Master",
    ...
    Title("cMF-64") -> "Candidate FMJD Master (64 squares)",
    ...
    Title("cMFF-64") -> "Woman Candidate FMJD Master (64 squares)",
